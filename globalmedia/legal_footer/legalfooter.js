...
/*  Updated 2013/12/04 by DTSS DMA - Updated TOU
/*  Updated 2014/11/06 by DTSS SE-DI - JL - removed Internet safety and changed links for TOU, Privacy Policy, etc.
...
// This Variable is used to build the HTML string that represents the whole footer. Written to document at then end of the script.
var lfDcWrtInf = ""

var lfIsValidColor = false

var _cFURL = location.href,
  isThisPageURL = _cFURL.toLowerCase(),
  ppLink = "",
  lgCDSIPQuery = "0";
...
var privacyPolicyCAText = "Your California Privacy Rights";
...
var lFArVersion = navigator.appVersion.split("MSIE"),
  lFVersion = parseFloat(lFArVersion[1]),
  lFBrowserAgent = navigator.userAgent,
  legalFooterWidth = 770;
...
try {
  if (legalFtrLine1 == null) {
    legalFtrLine1 = "<span style='font-weight:bold;'>" + document.title + "</span>";
  }
} catch (e) {
  try {
    if (legalFtrOpts) {
...
ppQuery = "pp";
lgSetPPQuery();
ppLink = "https://disneyprivacycenter.com/"
ppLinkShop = "https://disneyprivacycenter.com/"
...
var copyRight = "",
  copyRightType = "",
  ftTransfer = "http://transfer.go.com/cgi/transfer.dll?srvc=dis&goto=";
...
try {
  ...
  copyRight = "&copy; Disney. All rights reserved.";
}
...
lfDcWrtInf += "<style>a.dolFooterLnk,a.dolFooterLnk:visited,a.dolFooterLnk:hover,a.dolFooterLnk:active,a.dolFooterSmallLnk,a.dolFooterSmallLnk:visited,a.dolFooterSmallLnk:hover,a.dolFooterSmallLnk:active{color:" + 
              legalFooterColor + " !important;background-color:transparent !important;text-decoration:underline;}a.dolFooterLnkRed,a.dolFooterLnkRed:visited,a.dolFooterLnkRed:hover,a.dolFooterLnkRed:active{color:#FF0000 " + 
              "!important;background-color:transparent !important;text-decoration:underline;}</style>";
...
try {
  if (legalFtrLine1.toString() != "undefined") lfDcWrtInf += '<tr><td style="' + dolFooterSt + '" colspan="3">' + legalFtrLine1 + '</td></tr>';
} catch (e) {}
...
try {
  if (legalFtrLine2.toString() != "undefined") lfDcWrtInf += '<tr><td style="' + dolFooterSt + '" colspan="3">' + legalFtrLine2 + '</td></tr>';
} catch (e) {}

legalFooterHostName = location.hostname;
lgFtHrLn = '<hr style="border: 0; border-top: 1px solid #A3A3A3; height: 0px; background: #A3A3A3;">';

if (copyRight.indexOf("Disney") != -1 || 
	copyRight.indexOf("Buena Vista Home Entertainment") != -1 || 
	copyRight.indexOf("Buena Vista Pictures Marketing") != -1 || 
	copyRight.indexOf("Baby Einstein Company") != -1) { 
  ...
  if (!lgMinLinks) {
    lfDcWrtInf += '<a href="' + legalFooterImgLink + '" name="&lid=footer_legal_image_' + legalFooterCat + 
    			  '&lpos=footer_legal" class="dolFooterLnk" ' + ((lfDCOM3) ? 'id=\'legalFooterImageAnchor\'' : '') + '>';
  }
  ...
  if ((lFVersion >= 5.5 && lFVersion < 7) && (document.body.filters)) {
    lfDcWrtInf += '<img src="' + legalFooterImgPath + '/clear.gif" border="0" style="filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src=\'' + 
    	          legalFooterImgPath + '/' + legalFooterImg + '\')" id="lgDcomFtrImg">';
  } else {
...
if (!lgMinLinks) {
  /******** Guest Services ********/
  lfDcWrtInf += '<a href="' + ftTransfer +
    'http://home.disney.go.com/guestservices&name=g_legalFooter_guestservices" target="_top" class="dolFooterLnk" style="' +
    dolFooterLnk + '" name="&lid=footer_legal_GuestServices&lpos=footer_legal">' +
    ((lfDCOM3) ? '<span id=\'lgGuestServices\'>' : '') + 'Disney.com Guest Services/Help' + ((lfDCOM3) ? '</span>' : '') + '</a>&nbsp;|&nbsp;';

  /******** Site Map ********/
  lfDcWrtInf += '<a href="' + ftTransfer + 'http://home.disney.go.com/sitemap/&name=g_legalFooter_sitemap" target="_top" class="dolFooterLnk" style="' + dolFooterLnk + 
                '" name="&lid=footer_legal_SiteMap&lpos=footer_legal">' + ((lfDCOM3) ? '<span id=\'lgSiteMap\'>' : '') + 'Site Map' + ((lfDCOM3) ? '</span>' : '') + '</a><br />';
}

/******** Children's Online Privacy Policy ********/
lfDcWrtInf += '<a href="https://disneyprivacycenter.com/kids-privacy-policy/english/" target="_top" class="dolFooterLnk" style="' + dolFooterLnk + 
              '" name="&lid=footer_legal_childrensprivacy&lpos=footer_legal">' + ((lfDCOM3) ? '<span id=\'lgChildrensPrivacy\'>' : '') + 'Children\'s Online Privacy Policy' + ((lfDCOM3) ? '</span>' : '') + '</a>&nbsp;|&nbsp;';

/******** Privacy Policy ********/
if (!lFMCFtr) {
  lfDcWrtInf += '<a href="https://disneyprivacycenter.com/" target="_top" class="dolFooterLnk' + (updatePrivacyPolicyRED ? "Red" : "") + '" style="' + 
                (updatePrivacyPolicyRED ? dolFooterLnkRed : dolFooterLnk) + '" name="&lid=footer_legal_PrivacyPolicy&lpos=footer_legal">' + 
                ((lfDCOM3) ? '<span id=\'lgPrivacyPolicy\'>' : '') + privacyPolicyText + '</a>&nbsp;|&nbsp;';
}

/******** California Privacy Rights **********/
lfDcWrtInf += '<a href="https://disneyprivacycenter.com/notice-to-california-residents/" target="_top" class="dolFooterLnk' + (updatePrivacyPolicyRED ? "Red" : "") + '" style="' + 
              (updatePrivacyPolicyRED ? dolFooterLnkRed : dolFooterLnk) + '" name="&lid=footer_legal_CA_PrivacyPolicy&lpos=footer_legal">' + 
              ((lfDCOM3) ? '<span id=\'lgCAPrivacyPolicy\'>' : '') + privacyPolicyCAText + '</a>&nbsp;|&nbsp;';

/******** Interest Based Ads ********/
lfDcWrtInf += "<a href=\"http://preferences.truste.com/2.0/?type=disneycolor&affiliateId=115\" style=\"font-size:10pt !important;\" class=\"dolFooterLnk\" " + 
              " onclick=\"window.open('http://preferences.truste.com/2.0/?type=disneycolor&affiliateId=115','popup','width=986,height=878,scrollbars=yes, " + 
              "resizable=no,toolbar=no,directories=no,location=no,menubar=no,status=no,left=0,top=0'); return false\">Interest-Based Ads</a>&nbsp;|&nbsp;";

/******** Terms of Use ********/
lfDcWrtInf += '<a href="http://disneytermsofuse.com/" target="_top" class="dolFooterLnk" style="' + (termsOfUseRED ? dolFooterLnkRed : dolFooterLnk) + 
			  '" name="&lid=footer_legal_TermsOfUse&lpos=footer_legal">' + 
              ((lfDCOM3) ? '<span id=\'lgTermsOfUse\'>' : '') + termsOfUseText + '</a>&nbsp;|&nbsp;';

/********* Misc ***************/
if (lfCatLinks) {
  lfDcWrtInf += '<br /><a href="' + ftTransfer + 'http://corporate.disney.go.com/index.html&name=g_legalFooter_corpinfo" target="_top" class="dolFooterLnk" style="' + 
                 dolFooterLnk + '" name="&lid=footer_legal_CorpInfo&lpos=footer_legal">' + ((lfDCOM3) ? '<span id=\'lgCorporateInfo\'>' : '') + 'Corporate Info' + ((lfDCOM3) ? '</span>' : '') + '</a>&nbsp;|&nbsp;';

  lfDcWrtInf += '<a href="' + ftTransfer + 'http://home.disney.go.com/guestservices/legalnotices&name=g_legalFooter_legalnotices" target="_top" class="dolFooterLnk" style="' + 
                dolFooterLnk + '" name="&lid=footer_legal_LegalNotices&lpos=footer_legal">' + ((lfDCOM3) ? '<span id=\'lgLegalNotices\'>' : '') + 
                'Legal Notices' + ((lfDCOM3) ? '</span>' : '') + '</a>&nbsp;|&nbsp;';

  lfDcWrtInf += '<a href="' + ftTransfer + 'http://home.disney.go.com/more&name=g_legalFooter_moredsites" target="_top" class="dolFooterLnk" style="' + 
                dolFooterLnk + '" name="&lid=footer_legal_MoreDisneySites&lpos=footer_legal">' + ((lfDCOM3) ? '<span id=\'lgMoreDisneySites\'>' : '') + 
                'More Disney Sites' + ((lfDCOM3) ? '</span>' : '') + '</a><br />';
}

/******** Added Disney Rewards Visa link on Search pages 5/16/07 ********/
if (isThisPage("search.disney.go.com") || isThisPage("disney.go.com/search")) {
  lfDcWrtInf += '<br /><a href="' + ftTransfer + 'http://disney.go.com/visa/today/index.html?CELL=641W19&name=g_legalFooter_DisneyVisa" target="_top" class="dolFooterLnk" style="' + 
                dolFooterLnk + '" name="&lid=footer_legal_DisneyVisa&lpos=footer_legal"><span style="font-style:italic;">Disney Rewards</span>&reg; Visa&reg; Card</a><br />';
}

/******** Added Disney Rewards Visa link on ForYou 4/22/09 ********/
if (isThisPage("disney.go.com/foryou/disneyfans")) {
  lfDcWrtInf += '<br /><a href="' + ftTransfer + 'http://disney.go.com/visa/today/index.html?CELL=641W19&name=g_legalFooter_DisneyVisa" target="_top" class="dolFooterLnk" style="' + 
                dolFooterLnk + '" name="&lid=footer_legal_DisneyVisa&lpos=footer_legal"><span style="font-style:italic;">Disney Rewards</span>&reg; Visa&reg; Card</a>';
}

lfDcWrtInf += '<br /><span style="' + dolFooterSmallSt + '" ' + ((lfDCOM3) ? 'id=\'lgCopyRight\'' : '') + '>' + copyRight + '</span></td></tr><tbody></table></div><br />';

// Write out footer to document
document.write(lfDcWrtInf);

/***************  CEREBELLUM SCRIPT *****************/
document.write('<script src="//clog.go.com/log?srvc=dis&a=5" type="text/javascript" ></script>');
